        ...
        <a-form layout="vertical">
            <a-row>
                ...
                <a-col :xs="24" :sm="24" :md="18" :lg="18">
                    ...
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12" v-if="userType == 'customers'">
                            <a-form-item
                                :label="$t('user.nickname')"
                                name="nickname"
                                :help="rules.nickname ? rules.nickname.message : null"
                                :validateStatus="rules.nickname ? 'error' : null"
                            >
                                <a-input
                    ...
                    <a-row :gutter="16" v-if="userType == 'customers' || userType == 'suppliers'">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.bankaccount')"
                                name="bankaccount"
                                :help="rules.bankaccount ? rules.bankaccount.message : null"
                                :validateStatus="rules.bankaccount ? 'error' : null"
                            >
                                <a-input
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                ...
                                name="bankname"
                                :help="rules.bankname ? rules.bankname.message : null"
                                :validateStatus="rules.bankname ? 'error' : null"
                            >
                                <a-input
                    ...
                    <a-row :gutter="16" v-if="userType == 'customers' || userType == 'suppliers' ">
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12" v-if="userType == 'suppliers' ">
                            <a-form-item
                                :label="$t('user.supplier_type')"
                                name="supplier_type"
                                :help="rules.supplier_type ? rules.supplier_type.message : null"
                                :validateStatus="rules.supplier_type ? 'error' : null"
                            >
                                <a-input
                                    v-model:value="formData.supplier_type"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('user.supplier_type'),
                                        ])
                                    "
                                />
                            </a-form-item>
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12" v-if="userType == 'customers' ">
                            <a-form-item
                                ...
                                name="province"
                                :help="rules.province ? rules.province.message : null"
                                :validateStatus="rules.province ? 'error' : null"
                            >
                                <a-input
                    ...
                    <a-row :gutter="16" v-if="userType == 'customers'">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.postcode')"
                                name="postcode"
                                :help="rules.postcode ? rules.postcode.message : null"
                                :validateStatus="rules.postcode ? 'error' : null"
                            >
                                <a-input
                    ...
                    <a-row :gutter="16" v-if="userType == 'suppliers'">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.tax_document')"
                                name="tax_document"
                                :help="rules.tax_document ? rules.tax_document.message : null"
                                :validateStatus="rules.tax_document ? 'error' : null"
                            >
                                <a-input
                                    v-model:value="formData.tax_document"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('user.tax_document'),
                                        ])
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.supplier_tier')"
                                name="supplier_tier"
                                :help="rules.supplier_tier ? rules.supplier_tier.message : null"
                                :validateStatus="rules.supplier_tier ? 'error' : null"
                            >
                                <a-input
                                    v-model:value="formData.supplier_tier"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('user.supplier_tier'),
                                        ])
                                    "
                                />
                            </a-form-item>
                    ...
                    <a-row :gutter="16" v-if="userType == 'customers'">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.ref_invitation_name')"
                                name="ref_invitation_name"
                                :help="rules.ref_invitation_name ? rules.ref_invitation_name.message : null"
                                :validateStatus="rules.ref_invitation_name ? 'error' : null"
                            >
                                <a-input
                                    v-model:value="formData.ref_invitation_name"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('user.ref_invitation_name'),
                                        ])
                                    "
                                />
                            </a-form-item>
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.joined_event')"
                                name="joined_event"
                                :help="rules.joined_event ? rules.joined_event.message : null"
                                :validateStatus="rules.joined_event ? 'error' : null"
                            >
                                <a-input
                                    v-model:value="formData.joined_event"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('user.joined_event'),
                                        ])
                    ...
                    >
                        <a-col :span="24">
                            <a-form-item
                                ...
                                :class="formData.user_type == 'staff_members'
                                        ? 'required'
                                        : ''
                                "
                            >
                    ...
                    <a-row :gutter="16" v-if="userType == 'customers'">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.creditmemo')"
                                name="creditmemo"
                                :help="rules.creditmemo ? rules.creditmemo.message : null"
                                :validateStatus="rules.creditmemo ? 'error' : null"
                            >
                                <a-input
                                    v-model:value="formData.creditmemo"
                                    type="number"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('user.creditmemo'),
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('user.point')"
                                name="point"
                                :help="rules.point ? rules.point.message : null"
                                :validateStatus="rules.point ? 'error' : null"
                            >
                                <a-input
            ...
            <a-row :gutter="16" v-if="userType == 'suppliers'">
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-form-item
                        :label="$t('user.payment_channel')"
                        name="payment_channel"
                        :help="rules.payment_channel ? rules.payment_channel.message : null"
                        :validateStatus="rules.payment_channel ? 'error' : null"
                    >
                        <a-textarea
                            v-model:value="formData.payment_channel"
                            :placeholder="
                                $t('common.placeholder_default_text', [$t('user.payment_channel')])
                            "
            ...
            <a-row :gutter="16" v-if="userType == 'customers' || userType == 'suppliers'">
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-form-item
                        :label="$t('user.remark')"
                        name="remark"
                        :help="rules.remark ? rules.remark.message : null"
                        :validateStatus="rules.remark ? 'error' : null"
                    >
                        <a-textarea
                            v-model:value="formData.remark"
                            :placeholder="
                                $t('common.placeholder_default_text', [$t('user.remark')])
                            "
                            :auto-size="{ minRows: 2, maxRows: 3 }"
                        />
                    </a-form-item>
...
export default defineComponent({
    ...
    setup(props, {emit}) {
        ...
        onMounted(() => {
            ...
            // formData.value = { ...props.addEditData, "userType": props.userType };
        });
