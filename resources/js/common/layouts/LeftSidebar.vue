                    ...
                    >
                        ...
                        <a-menu-item
                            @click="
                                () => {
                                    menuSelected();
                                    $router.push({ name: 'admin.goldtype.index' });
                                }
                            "
                            key="goldtype"
                            v-if="
                                permsArray.includes('goldtype_view') ||
                                permsArray.includes('admin')
                            "
                        >
                            {{ $t("menu.goldtype") }}
                        ...
                        <a-menu-item
                            @click="
                                () => {
                                    menuSelected();
                                    $router.push({ name: 'admin.stonetype.index' });
                                }
                            "
                            key="stonetype"
                            v-if="
                                permsArray.includes('stonetype_view') ||
                                permsArray.includes('admin')
                            "
                        >
                            {{ $t("menu.stonetype") }}
                        ...
                        <a-menu-item
                            @click="
                                () => {
                                    menuSelected();
                                    $router.push({ name: 'admin.jewerlygroup.index' });
                                }
                            "
                            key="jewerlygroup"
                            v-if="
                                permsArray.includes('jewerlygroup_view') ||
                                permsArray.includes('admin')
                            "
                        >
                            {{ $t("menu.jewerlygroup") }}
                        ...
                        <a-menu-item
                            @click="
                                () => {
                                    menuSelected();
                                    $router.push({
                                        name: 'admin.stock.refund.index',
                                    });
                                }
                            "
                            key="refund"
                            v-if="
                                permsArray.includes('refunds_view') ||
                                permsArray.includes('admin')
                            "
                        >
                            {{ $t("menu.refund") }}
