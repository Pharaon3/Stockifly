...
ApiRoute::group(['namespace' => 'App\Http\Controllers\Api'], function () {
    ...
    ApiRoute::get('stonetype', ['as' => 'api.stonetype.index', 'uses' => 'StonetypeController@index']);
    ApiRoute::get('jewerlygroup', ['as' => 'api.jewerlygroup.index', 'uses' => 'JewerlygroupController@index']);
    ApiRoute::get('goldtype', ['as' => 'api.stonetype.index', 'uses' => 'GoldtypeController@index']);
    ...
    ApiRoute::group(['middleware' => ['api.permission.check', 'api.auth.check', 'license-expire']], function () {
        ...
        ApiRoute::resource('stonetype', 'StonetypeController', ['as' => 'api', 'except' => ['index']]);
        ApiRoute::resource('jewerlygroup', 'JewerlygroupController', ['as' => 'api', 'except' => ['index']]);
        ApiRoute::resource('goldtype', 'GoldtypeController', ['as' => 'api', 'except' => ['index']]);
        ...
        ApiRoute::resource('refund', 'RefundController', $options);
