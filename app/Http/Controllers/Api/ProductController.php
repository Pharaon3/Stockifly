...
class ProductController extends ApiBaseController
{
    ...
    public function searchProduct(Request $request)
    {
        ...
        foreach ($products as $product) {
            ...
            if ($orderType == 'purchases' || $orderType == 'quotations' || ($orderType == 'sales' && $productDetails->current_stock > 0) || $orderType == 'refund' || ($orderType == 'sales-returns') || ($orderType == 'purchase-returns' && $productDetails->current_stock > 0) || ($orderType == 'stock-transfers' && $productDetails->current_stock > 0)) {
                ...
                } else if ($orderType == 'sales' || $orderType == 'refund' || $orderType == 'sales-returns' || $orderType == 'quotations') {
