...
class LangTrans
{
    public static $mainTranslations = [
        ...
        'user' => [
            ...
            'ref_invitation_name' => 'Ref Invitation Name',
            'bankname' => 'Bank Name',
        ...
        'stonetype' => [
            'add' => 'Add New Stone Type',
            'edit' => 'Edit Stone Type',
            'created' => 'Stone Type Created Successfully',
            'updated' => 'Stone Type Updated Successfully',
            'deleted' => 'Stone Type Deleted Successfully',
            'delete_message' => 'Are you sure you want to delete this Stone Type?',
            'selected_delete_message' => 'Are you sure you want to delete selected Stone Type?',
            'details' => 'Stone Type Details',
            'name' => 'Name',
            'slug' => 'Slug',
            'logo' => 'Stone Type Logo',
            'import_stonetype' => 'Import Stone Type',
        ],
        'goldtype' => [
            'add' => 'Add New Gold Type',
            'edit' => 'Edit Gold Type',
            'created' => 'Gold Type Created Successfully',
            'updated' => 'Gold Type Updated Successfully',
            'deleted' => 'Gold Type Deleted Successfully',
            'delete_message' => 'Are you sure you want to delete this Gold Type?',
            'selected_delete_message' => 'Are you sure you want to delete selected Gold Type?',
            'details' => 'Gold Type Details',
            'name' => 'Name',
            'slug' => 'Slug',
            'logo' => 'Gold Type Logo',
            'import_goldtype' => 'Import Gold Type',
        ],
        'jewerlygroup' => [
            'add' => 'Add New Jewerly Group',
            'edit' => 'Edit Jewerly Group',
            'created' => 'Jewerly Group Created Successfully',
            'updated' => 'Jewerly Group Updated Successfully',
            'deleted' => 'Jewerly Group Deleted Successfully',
            'delete_message' => 'Are you sure you want to delete this Jewerly Group?',
            'selected_delete_message' => 'Are you sure you want to delete selected Jewerly Group?',
            'details' => 'Jewerly Group Details',
            'name' => 'Name',
            'slug' => 'Slug',
            'logo' => 'Jewerly Group Logo',
            'import_jewerlygroup' => 'Import Jewerly Group',
        ],
        'product' => [
            'add' => 'Add New Product',
            'edit' => 'Edit Product',
        ...
        'refund' => [
            ...
            'selected_delete_message' => 'Are you sure you want to delete selected refund?',
