...
class Product extends BaseModel
{
    ...
    protected $filterable = ['id', 'products.id', 'products.name', 
                            'products.supplier', 'supplier', 'name', 
                            'size', 'model', 'design', 'gold_type',
                            'jewerly_group', 'stone_type',
                            'item_code', 'category_id', 'brand_id'];
